...
|------------- | ------------- | -------------|
|[**getAllItemsResourcesList**](#getallitemsresourceslist) | **GET** /{game}/v1/{language}/items/resources/all | List All Resources|
|[**getItemsResourceSearch**](#getitemsresourcesearch) | **GET** /{game}/v1/{language}/items/resources/search | Search Resources|
|[**getItemsResourcesList**](#getitemsresourceslist) | **GET** /{game}/v1/{language}/items/resources | List Resources|
|[**getItemsResourcesSingle**](#getitemsresourcessingle) | **GET** /{game}/v1/{language}/items/resources/{ankama_id} | Single Resources|

# **getAllItemsResourcesList**
> ListItems getAllItemsResourcesList()
...
const { status, data } = await apiInstance.getAllItemsResourcesList(
    language,
    game,
    sortLevel,
    filterMinLevel,
...
> Array<ListItem> getItemsResourceSearch()
...
const { status, data } = await apiInstance.getItemsResourceSearch(
    language,
    game,
    query,
    filterMinLevel,
...
> ListItems getItemsResourcesList()
...
const { status, data } = await apiInstance.getItemsResourcesList(
    language,
    game,
    sortLevel,
    filterMinLevel,
...
> Resource getItemsResourcesSingle()
...
const { status, data } = await apiInstance.getItemsResourcesSingle(
    language,
    ankamaId,
    game
);
