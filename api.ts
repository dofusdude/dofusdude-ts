...
export interface Equipment {
    ...
    /**
     * 
     * @type {ItemListEntryParentSet}
     * @memberof Equipment
     */
    'parent_set'?: ItemListEntryParentSet | null;
}
/**
 * 
 * @export
...
export interface EquipmentSet {
    ...
    /**
     * 
     * @type {Array<Array<SetEffectsEntry>>}
     * @memberof EquipmentSet
     */
    'effects'?: Array<Array<SetEffectsEntry>> | null;
    /**
     * 
     * @type {number}
     * @memberof EquipmentSet
 ...
 * 
 * @export
 * @interface GetGameSearch200ResponseInner
 */
export interface GetGameSearch200ResponseInner {
    /**
     * Name of the hit. The query could still have matched with the description only.
     * @type {string}
     * @memberof GetGameSearch200ResponseInner
     */
    'name'?: string;
    /**
 ...
 * 
 * @export
 * @interface GetMetaVersion200Response
 */
export interface GetMetaVersion200Response {
    /**
     * 
     * @type {string}
     * @memberof GetMetaVersion200Response
     */
    'version'?: string;
    /**
     * 
...
export interface ItemListEntry {
    ...
    /**
     * 
     * @type {ItemListEntryRange}
     * @memberof ItemListEntry
     */
    'range'?: ItemListEntryRange | null;
}
/**
 * 
 * @export
 * @interface ItemListEntryParentSet
 */
export interface ItemListEntryParentSet {
    /**
     * 
     * @type {number}
     * @memberof ItemListEntryParentSet
     */
    'id'?: number;
    /**
     * 
 ...
 * 
 * @export
 * @interface ItemListEntryRange
 */
export interface ItemListEntryRange {
    /**
     * 
     * @type {number}
     * @memberof ItemListEntryRange
     */
    'min'?: number;
    /**
     * 
 ...
 * 
 * @export
 * @interface SetEffectsEntry
 */
export interface SetEffectsEntry {
    /**
     * minimum int value, can be a single if ignore_int_max and no ignore_int_min
     * @type {number}
     * @memberof SetEffectsEntry
     */
    'int_minimum'?: number;
    /**
     * maximum int value, if not ignore_int_max and not ignore_int_min, the effect has a range value
 ...
 * 
 * @export
 * @interface SetEffectsEntryType
 */
export interface SetEffectsEntryType {
    /**
     * 
     * @type {string}
     * @memberof SetEffectsEntryType
     */
    'name'?: string;
    /**
     * 
...
export const AlmanaxApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAlmanaxDate(language: GetAlmanaxDateLanguageEnum, date: string, options?: RawAxiosRequestConfig): AxiosPromise<AlmanaxEntry> {
         ...
         * @throws {RequiredError}
         */
        getAlmanaxRange(language: GetAlmanaxRangeLanguageEnum, filterBonusType?: string, rangeFrom?: string, rangeTo?: string, rangeSize?: number, timezone?: string, options?: RawAxiosRequestConfig): AxiosPromise<Array<AlmanaxEntry>> {
...
export const ConsumablesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {GetAllItemsConsumablesListGameEnum} game 
         ...
         * @param {Set<string>} [filterTypeEnum] multi-filter results with the english type name. Add with \&quot;wood\&quot; or \&quot;+wood\&quot; and exclude with \&quot;-wood\&quot;.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllItemsConsumablesList: async (language: GetAllItemsConsumablesListLanguageEnum, game: GetAllItemsConsumablesListGameEnum, sortLevel?: GetAllItemsConsumablesListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, acceptEncoding?: GetAllItemsConsumablesListAcceptEncodingEnum, filterTypeEnum?: Set<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'language' is not null or undefined
            ...
            if (filterTypeEnum) {
                localVarQueryParameter['filter[type_enum]'] = Array.from(filterTypeEnum).join(COLLECTION_FORMATS.csv);
            }
         ...
         * @param {GetItemsConsumablesListGameEnum} game 
         ...
         * @param {GetItemsConsumablesSearchGameEnum} game 
         ...
         * @throws {RequiredError}
         */
        getItemsConsumablesSearch: async (language: GetItemsConsumablesSearchLanguageEnum, game: GetItemsConsumablesSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'language' is not null or undefined
         ...
         * @param {GetItemsConsumablesSingleGameEnum} game 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
...
export const ConsumablesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllItemsConsumablesList(language: GetAllItemsConsumablesListLanguageEnum, game: GetAllItemsConsumablesListGameEnum, sortLevel?: GetAllItemsConsumablesListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, acceptEncoding?: GetAllItemsConsumablesListAcceptEncodingEnum, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ItemsListPaged>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllItemsConsumablesList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding, filterTypeEnum, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async getItemsConsumablesList(language: GetItemsConsumablesListLanguageEnum, game: GetItemsConsumablesListGameEnum, sortLevel?: GetItemsConsumablesListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, pageSize?: number, pageNumber?: number, fieldsItem?: Set<GetItemsConsumablesListFieldsItemEnum>, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ItemsListPaged>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getItemsConsumablesList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem, filterTypeEnum, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async getItemsConsumablesSearch(language: GetItemsConsumablesSearchLanguageEnum, game: GetItemsConsumablesSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ItemListEntry>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getItemsConsumablesSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const ConsumablesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllItemsConsumablesList(language: GetAllItemsConsumablesListLanguageEnum, game: GetAllItemsConsumablesListGameEnum, sortLevel?: GetAllItemsConsumablesListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, acceptEncoding?: GetAllItemsConsumablesListAcceptEncodingEnum, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): AxiosPromise<ItemsListPaged> {
            return localVarFp.getAllItemsConsumablesList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding, filterTypeEnum, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve a list of consumable items.
         * @summary List Consumables
         ...
         * @throws {RequiredError}
         */
        getItemsConsumablesList(language: GetItemsConsumablesListLanguageEnum, game: GetItemsConsumablesListGameEnum, sortLevel?: GetItemsConsumablesListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, pageSize?: number, pageNumber?: number, fieldsItem?: Set<GetItemsConsumablesListFieldsItemEnum>, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): AxiosPromise<ItemsListPaged> {
            return localVarFp.getItemsConsumablesList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem, filterTypeEnum, options).then((request) => request(axios, basePath));
        },
        /**
         * Search in all names and descriptions of consumable items with a query.
         * @summary Search Consumables
         ...
         * @throws {RequiredError}
         */
        getItemsConsumablesSearch(language: GetItemsConsumablesSearchLanguageEnum, game: GetItemsConsumablesSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): AxiosPromise<Array<ItemListEntry>> {
            return localVarFp.getItemsConsumablesSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve a specific consumable item with id.
         * @summary Single Consumables
...
export class ConsumablesApi extends BaseAPI {
     ...
     */
    public getAllItemsConsumablesList(language: GetAllItemsConsumablesListLanguageEnum, game: GetAllItemsConsumablesListGameEnum, sortLevel?: GetAllItemsConsumablesListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, acceptEncoding?: GetAllItemsConsumablesListAcceptEncodingEnum, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig) {
        return ConsumablesApiFp(this.configuration).getAllItemsConsumablesList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding, filterTypeEnum, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getItemsConsumablesList(language: GetItemsConsumablesListLanguageEnum, game: GetItemsConsumablesListGameEnum, sortLevel?: GetItemsConsumablesListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, pageSize?: number, pageNumber?: number, fieldsItem?: Set<GetItemsConsumablesListFieldsItemEnum>, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig) {
        return ConsumablesApiFp(this.configuration).getItemsConsumablesList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem, filterTypeEnum, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ConsumablesApi
     */
    public getItemsConsumablesSearch(language: GetItemsConsumablesSearchLanguageEnum, game: GetItemsConsumablesSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig) {
        return ConsumablesApiFp(this.configuration).getItemsConsumablesSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum, options).then((request) => request(this.axios, this.basePath));
    }
...
export const CosmeticsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {GetAllCosmeticsListGameEnum} game 
         ...
         * @throws {RequiredError}
         */
        getAllCosmeticsList: async (language: GetAllCosmeticsListLanguageEnum, game: GetAllCosmeticsListGameEnum, sortLevel?: GetAllCosmeticsListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, acceptEncoding?: GetAllCosmeticsListAcceptEncodingEnum, filterTypeEnum?: Set<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'language' is not null or undefined
         ...
         * @param {GetCosmeticsListGameEnum} game 
         ...
         * @param {GetCosmeticsSearchGameEnum} game 
         * @param {string} query case sensitive search query
         * @param {string} [filterTypeName] only results with the translated type name
         * @param {number} [filterMinLevel] only results which level is equal or above this value
         * @param {number} [filterMaxLevel] only results which level is equal or below this value
         ...
         * @throws {RequiredError}
         */
        getCosmeticsSearch: async (language: GetCosmeticsSearchLanguageEnum, game: GetCosmeticsSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'language' is not null or undefined
         ...
         * @param {number} ankamaId identifier
         * @param {GetCosmeticsSingleGameEnum} game 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
...
export const CosmeticsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllCosmeticsList(language: GetAllCosmeticsListLanguageEnum, game: GetAllCosmeticsListGameEnum, sortLevel?: GetAllCosmeticsListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, acceptEncoding?: GetAllCosmeticsListAcceptEncodingEnum, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ItemsListPaged>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllCosmeticsList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding, filterTypeEnum, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async getCosmeticsList(language: GetCosmeticsListLanguageEnum, game: GetCosmeticsListGameEnum, sortLevel?: GetCosmeticsListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, pageSize?: number, pageNumber?: number, fieldsItem?: Set<GetCosmeticsListFieldsItemEnum>, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ItemsListPaged>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCosmeticsList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem, filterTypeEnum, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
        ...
        async getCosmeticsSearch(language: GetCosmeticsSearchLanguageEnum, game: GetCosmeticsSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ItemListEntry>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCosmeticsSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const CosmeticsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllCosmeticsList(language: GetAllCosmeticsListLanguageEnum, game: GetAllCosmeticsListGameEnum, sortLevel?: GetAllCosmeticsListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, acceptEncoding?: GetAllCosmeticsListAcceptEncodingEnum, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): AxiosPromise<ItemsListPaged> {
            return localVarFp.getAllCosmeticsList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding, filterTypeEnum, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve a list of cosmetic items.
         * @summary List Cosmetics
         ...
         * @throws {RequiredError}
         */
        getCosmeticsList(language: GetCosmeticsListLanguageEnum, game: GetCosmeticsListGameEnum, sortLevel?: GetCosmeticsListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, pageSize?: number, pageNumber?: number, fieldsItem?: Set<GetCosmeticsListFieldsItemEnum>, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): AxiosPromise<ItemsListPaged> {
            return localVarFp.getCosmeticsList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem, filterTypeEnum, options).then((request) => request(axios, basePath));
        },
        /**
         * Search in all names and descriptions of cosmetic items with a query.
         * @summary Search Cosmetics
         ...
         * @throws {RequiredError}
         */
        getCosmeticsSearch(language: GetCosmeticsSearchLanguageEnum, game: GetCosmeticsSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): AxiosPromise<Array<ItemListEntry>> {
            return localVarFp.getCosmeticsSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve a specific cosmetic item with id.
         * @summary Single Cosmetics
         ...
         * @throws {RequiredError}
         */
        getCosmeticsSingle(language: GetCosmeticsSingleLanguageEnum, ankamaId: number, game: GetCosmeticsSingleGameEnum, options?: RawAxiosRequestConfig): AxiosPromise<Cosmetic> {
...
export class CosmeticsApi extends BaseAPI {
     ...
     */
    public getAllCosmeticsList(language: GetAllCosmeticsListLanguageEnum, game: GetAllCosmeticsListGameEnum, sortLevel?: GetAllCosmeticsListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, acceptEncoding?: GetAllCosmeticsListAcceptEncodingEnum, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig) {
        return CosmeticsApiFp(this.configuration).getAllCosmeticsList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding, filterTypeEnum, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CosmeticsApi
     */
    public getCosmeticsList(language: GetCosmeticsListLanguageEnum, game: GetCosmeticsListGameEnum, sortLevel?: GetCosmeticsListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, pageSize?: number, pageNumber?: number, fieldsItem?: Set<GetCosmeticsListFieldsItemEnum>, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig) {
        return CosmeticsApiFp(this.configuration).getCosmeticsList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem, filterTypeEnum, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CosmeticsApi
     */
    public getCosmeticsSearch(language: GetCosmeticsSearchLanguageEnum, game: GetCosmeticsSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig) {
        return CosmeticsApiFp(this.configuration).getCosmeticsSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum, options).then((request) => request(this.axios, this.basePath));
    }
...
export const EquipmentApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {GetAllItemsEquipmentListGameEnum} game 
         ...
         * @throws {RequiredError}
         */
        getAllItemsEquipmentList: async (language: GetAllItemsEquipmentListLanguageEnum, game: GetAllItemsEquipmentListGameEnum, sortLevel?: GetAllItemsEquipmentListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, acceptEncoding?: GetAllItemsEquipmentListAcceptEncodingEnum, filterTypeEnum?: Set<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'language' is not null or undefined
         ...
         * @param {GetItemsEquipmentListGameEnum} game 
         ...
         * @param {GetItemsEquipmentSearchGameEnum} game 
         * @param {string} query case sensitive search query
         * @param {string} [filterTypeName] only results with the translated type name
         * @param {number} [filterMinLevel] only results which level is equal or above this value
         * @param {number} [filterMaxLevel] only results which level is equal or below this value
         ...
         * @throws {RequiredError}
         */
        getItemsEquipmentSearch: async (language: GetItemsEquipmentSearchLanguageEnum, game: GetItemsEquipmentSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'language' is not null or undefined
         ...
         * @param {number} ankamaId identifier
         * @param {GetItemsEquipmentSingleGameEnum} game 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
...
export const EquipmentApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllItemsEquipmentList(language: GetAllItemsEquipmentListLanguageEnum, game: GetAllItemsEquipmentListGameEnum, sortLevel?: GetAllItemsEquipmentListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, acceptEncoding?: GetAllItemsEquipmentListAcceptEncodingEnum, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ItemsListPaged>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllItemsEquipmentList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding, filterTypeEnum, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
        ...
        async getItemsEquipmentList(language: GetItemsEquipmentListLanguageEnum, game: GetItemsEquipmentListGameEnum, sortLevel?: GetItemsEquipmentListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, pageSize?: number, pageNumber?: number, fieldsItem?: Set<GetItemsEquipmentListFieldsItemEnum>, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ItemsListPaged>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getItemsEquipmentList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem, filterTypeEnum, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
        ...
        async getItemsEquipmentSearch(language: GetItemsEquipmentSearchLanguageEnum, game: GetItemsEquipmentSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ItemListEntry>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getItemsEquipmentSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const EquipmentApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllItemsEquipmentList(language: GetAllItemsEquipmentListLanguageEnum, game: GetAllItemsEquipmentListGameEnum, sortLevel?: GetAllItemsEquipmentListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, acceptEncoding?: GetAllItemsEquipmentListAcceptEncodingEnum, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): AxiosPromise<ItemsListPaged> {
            return localVarFp.getAllItemsEquipmentList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding, filterTypeEnum, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve a list of equipment items.
         * @summary List Equipment
         ...
         * @throws {RequiredError}
         */
        getItemsEquipmentList(language: GetItemsEquipmentListLanguageEnum, game: GetItemsEquipmentListGameEnum, sortLevel?: GetItemsEquipmentListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, pageSize?: number, pageNumber?: number, fieldsItem?: Set<GetItemsEquipmentListFieldsItemEnum>, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): AxiosPromise<ItemsListPaged> {
            return localVarFp.getItemsEquipmentList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem, filterTypeEnum, options).then((request) => request(axios, basePath));
        },
        /**
         * Search in all names and descriptions of equipment items with a query.
         * @summary Search Equipment
         ...
         * @throws {RequiredError}
         */
        getItemsEquipmentSearch(language: GetItemsEquipmentSearchLanguageEnum, game: GetItemsEquipmentSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): AxiosPromise<Array<ItemListEntry>> {
            return localVarFp.getItemsEquipmentSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve a specific equipment item with id.
         * @summary Single Equipment
...
export class EquipmentApi extends BaseAPI {
     ...
     */
    public getAllItemsEquipmentList(language: GetAllItemsEquipmentListLanguageEnum, game: GetAllItemsEquipmentListGameEnum, sortLevel?: GetAllItemsEquipmentListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, acceptEncoding?: GetAllItemsEquipmentListAcceptEncodingEnum, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig) {
        return EquipmentApiFp(this.configuration).getAllItemsEquipmentList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding, filterTypeEnum, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getItemsEquipmentList(language: GetItemsEquipmentListLanguageEnum, game: GetItemsEquipmentListGameEnum, sortLevel?: GetItemsEquipmentListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, pageSize?: number, pageNumber?: number, fieldsItem?: Set<GetItemsEquipmentListFieldsItemEnum>, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig) {
        return EquipmentApiFp(this.configuration).getItemsEquipmentList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem, filterTypeEnum, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EquipmentApi
     */
    public getItemsEquipmentSearch(language: GetItemsEquipmentSearchLanguageEnum, game: GetItemsEquipmentSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig) {
        return EquipmentApiFp(this.configuration).getItemsEquipmentSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum, options).then((request) => request(this.axios, this.basePath));
    }
...
export const GameApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {GetGameSearchGameEnum} game 
         * @param {string} query search query
         * @param {Set<GetGameSearchFilterTypeEnum>} [filterType] only results with all specific type
         * @param {number} [limit] maximum number of returned results
         * @param {Set<GetGameSearchFieldsItemEnum>} [fieldsItem] adds fields from the item search to the list entries if the hit is a item. Multiple comma separated values allowed.
         * @param {Set<string>} [filterTypeEnum] multi-filter results with the english item type name, including \&quot;mount\&quot; and \&quot;set\&quot; from filter[type]. Add with \&quot;wood\&quot; or \&quot;+wood\&quot; and exclude with \&quot;-wood\&quot;.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getGameSearch: async (language: GetGameSearchLanguageEnum, game: GetGameSearchGameEnum, query: string, filterType?: Set<GetGameSearchFilterTypeEnum>, limit?: number, fieldsItem?: Set<GetGameSearchFieldsItemEnum>, filterTypeEnum?: Set<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'language' is not null or undefined
            ...
            const localVarPath = `/{game}/{language}/search`
                .replace(`{${"language"}}`, encodeURIComponent(String(language)))
                .replace(`{${"game"}}`, encodeURIComponent(String(game)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            if (filterType) {
                localVarQueryParameter['filter[type]'] = Array.from(filterType).join(COLLECTION_FORMATS.csv);
            }
         ...
         * @param {GetItemsAllSearchGameEnum} game 
         * @param {string} query case sensitive search query
         ...
         * @throws {RequiredError}
         */
        getItemsAllSearch: async (language: GetItemsAllSearchLanguageEnum, game: GetItemsAllSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'language' is not null or undefined
...
export const GameApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getGameSearch(language: GetGameSearchLanguageEnum, game: GetGameSearchGameEnum, query: string, filterType?: Set<GetGameSearchFilterTypeEnum>, limit?: number, fieldsItem?: Set<GetGameSearchFieldsItemEnum>, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<GetGameSearch200ResponseInner>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getGameSearch(language, game, query, filterType, limit, fieldsItem, filterTypeEnum, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async getItemsAllSearch(language: GetItemsAllSearchLanguageEnum, game: GetItemsAllSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ItemsListEntryTyped>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getItemsAllSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const GameApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getGameSearch(language: GetGameSearchLanguageEnum, game: GetGameSearchGameEnum, query: string, filterType?: Set<GetGameSearchFilterTypeEnum>, limit?: number, fieldsItem?: Set<GetGameSearchFieldsItemEnum>, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): AxiosPromise<Array<GetGameSearch200ResponseInner>> {
            return localVarFp.getGameSearch(language, game, query, filterType, limit, fieldsItem, filterTypeEnum, options).then((request) => request(axios, basePath));
        },
        /**
         * Search in all names and descriptions of Dofus items (including all subtypes) with a query.
         * @summary Search All Items
         ...
         * @throws {RequiredError}
         */
        getItemsAllSearch(language: GetItemsAllSearchLanguageEnum, game: GetItemsAllSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): AxiosPromise<Array<ItemsListEntryTyped>> {
            return localVarFp.getItemsAllSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class GameApi extends BaseAPI {
     ...
     * @memberof GameApi
     */
    public getGameSearch(language: GetGameSearchLanguageEnum, game: GetGameSearchGameEnum, query: string, filterType?: Set<GetGameSearchFilterTypeEnum>, limit?: number, fieldsItem?: Set<GetGameSearchFieldsItemEnum>, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig) {
        return GameApiFp(this.configuration).getGameSearch(language, game, query, filterType, limit, fieldsItem, filterTypeEnum, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof GameApi
     */
    public getItemsAllSearch(language: GetItemsAllSearchLanguageEnum, game: GetItemsAllSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig) {
        return GameApiFp(this.configuration).getItemsAllSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum, options).then((request) => request(this.axios, this.basePath));
    }
}
 ...
 * @export
 */
export const GetGameSearchFilterTypeEnum = {
...
export type GetGameSearchFilterTypeEnum = typeof GetGameSearchFilterTypeEnum[keyof typeof GetGameSearchFilterTypeEnum];
/**
 * @export
 */
...
export const MetaApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getItemTypes: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/dofus2/meta/items/types`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @param {GetMetaAlmanaxBonusesLanguageEnum} language 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        ...
        getMetaVersion: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/dofus2/meta/version`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const MetaApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getItemTypes(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<string>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getItemTypes(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async getMetaVersion(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetMetaVersion200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getMetaVersion(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const MetaApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getGameSearchTypes(options?: RawAxiosRequestConfig): AxiosPromise<Array<string>> {
            return localVarFp.getGameSearchTypes(options).then((request) => request(axios, basePath));
        },
        /**
         * Get all types of all items. Primarily used for filtering more detailed types in listings or search endpoints. All names are english for comparing them inside applications. Ordering is not guaranteed to persist with game updates.
         * @summary Available Item Types
         ...
         * @throws {RequiredError}
         */
        getItemTypes(options?: RawAxiosRequestConfig): AxiosPromise<Array<string>> {
            return localVarFp.getItemTypes(options).then((request) => request(axios, basePath));
        },
        /**
         * Get all the available bonuses and their id for filtering them in the range endpoint.
         * @summary Available Almanax Bonuses
         ...
         * @throws {RequiredError}
         */
        getMetaElements(options?: RawAxiosRequestConfig): AxiosPromise<Array<string>> {
         ...
         * @throws {RequiredError}
         */
        getMetaVersion(options?: RawAxiosRequestConfig): AxiosPromise<GetMetaVersion200Response> {
            return localVarFp.getMetaVersion(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class MetaApi extends BaseAPI {
     ...
     * @memberof MetaApi
     */
    public getItemTypes(options?: RawAxiosRequestConfig) {
        return MetaApiFp(this.configuration).getItemTypes(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof MetaApi
     */
    public getMetaVersion(options?: RawAxiosRequestConfig) {
        return MetaApiFp(this.configuration).getMetaVersion(options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const MountsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {GetAllMountsListGameEnum} game 
         ...
         * @param {GetMountsListGameEnum} game 
         * @param {string} [filterFamilyName] only results with the translated family name
         * @param {number} [pageSize] size of the results from the list. -1 disables pagination and gets all in one response.
         * @param {number} [pageNumber] page number based on the current page[size]. So you could get page 1 with 8 entrys and page 2 would have entries 8 to 16.
         ...
         * @param {GetMountsSearchGameEnum} game 
         * @param {string} query case sensitive search query
         * @param {string} [filterFamilyName] only results with the translated family name
         * @param {number} [limit] maximum number of returned results
         * @param {*} [options] Override http request option.
         ...
         * @param {number} ankamaId identifier
         * @param {GetMountsSingleGameEnum} game 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
...
export const MountsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllMountsList(language: GetAllMountsListLanguageEnum, game: GetAllMountsListGameEnum, filterFamilyName?: string, acceptEncoding?: GetAllMountsListAcceptEncodingEnum, options?: RawAxiosRequestConfig): AxiosPromise<MountsListPaged> {
         ...
         * @throws {RequiredError}
         */
        getMountsList(language: GetMountsListLanguageEnum, game: GetMountsListGameEnum, filterFamilyName?: string, pageSize?: number, pageNumber?: number, fieldsMount?: Set<GetMountsListFieldsMountEnum>, options?: RawAxiosRequestConfig): AxiosPromise<MountsListPaged> {
         ...
         * @throws {RequiredError}
         */
        getMountsSearch(language: GetMountsSearchLanguageEnum, game: GetMountsSearchGameEnum, query: string, filterFamilyName?: string, limit?: number, options?: RawAxiosRequestConfig): AxiosPromise<Array<MountListEntry>> {
...
export const QuestItemsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {GetAllItemsQuestListGameEnum} game 
         ...
         * @throws {RequiredError}
         */
        getAllItemsQuestList: async (language: GetAllItemsQuestListLanguageEnum, game: GetAllItemsQuestListGameEnum, sortLevel?: GetAllItemsQuestListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, acceptEncoding?: GetAllItemsQuestListAcceptEncodingEnum, filterTypeEnum?: Set<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'language' is not null or undefined
         ...
         * @param {number} ankamaId identifier
         * @param {GetItemQuestSingleGameEnum} game 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
         ...
         * @param {GetItemsQuestListGameEnum} game 
         ...
         * @throws {RequiredError}
         */
        getItemsQuestList: async (language: GetItemsQuestListLanguageEnum, game: GetItemsQuestListGameEnum, sortLevel?: GetItemsQuestListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, pageSize?: number, pageNumber?: number, fieldsItem?: Set<GetItemsQuestListFieldsItemEnum>, filterTypeEnum?: Set<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'language' is not null or undefined
         ...
         * @param {GetItemsQuestSearchGameEnum} game 
         * @param {string} query case sensitive search query
         * @param {string} [filterTypeName] only results with the translated type name
         * @param {number} [filterMinLevel] only results which level is equal or above this value
         * @param {number} [filterMaxLevel] only results which level is equal or below this value
         ...
         * @throws {RequiredError}
         */
        getItemsQuestSearch: async (language: GetItemsQuestSearchLanguageEnum, game: GetItemsQuestSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'language' is not null or undefined
...
export const QuestItemsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllItemsQuestList(language: GetAllItemsQuestListLanguageEnum, game: GetAllItemsQuestListGameEnum, sortLevel?: GetAllItemsQuestListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, acceptEncoding?: GetAllItemsQuestListAcceptEncodingEnum, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ItemsListPaged>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllItemsQuestList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding, filterTypeEnum, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async getItemsQuestList(language: GetItemsQuestListLanguageEnum, game: GetItemsQuestListGameEnum, sortLevel?: GetItemsQuestListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, pageSize?: number, pageNumber?: number, fieldsItem?: Set<GetItemsQuestListFieldsItemEnum>, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ItemsListPaged>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getItemsQuestList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem, filterTypeEnum, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
        ...
        async getItemsQuestSearch(language: GetItemsQuestSearchLanguageEnum, game: GetItemsQuestSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ItemListEntry>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getItemsQuestSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const QuestItemsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllItemsQuestList(language: GetAllItemsQuestListLanguageEnum, game: GetAllItemsQuestListGameEnum, sortLevel?: GetAllItemsQuestListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, acceptEncoding?: GetAllItemsQuestListAcceptEncodingEnum, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): AxiosPromise<ItemsListPaged> {
            return localVarFp.getAllItemsQuestList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding, filterTypeEnum, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve a specific quest item with id.
         * @summary Single Quest Items
         ...
         * @throws {RequiredError}
         */
        getItemsQuestList(language: GetItemsQuestListLanguageEnum, game: GetItemsQuestListGameEnum, sortLevel?: GetItemsQuestListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, pageSize?: number, pageNumber?: number, fieldsItem?: Set<GetItemsQuestListFieldsItemEnum>, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): AxiosPromise<ItemsListPaged> {
            return localVarFp.getItemsQuestList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem, filterTypeEnum, options).then((request) => request(axios, basePath));
        },
        /**
         * Search in all names and descriptions of quest items with a query.
         * @summary Search Quest Items
         ...
         * @throws {RequiredError}
         */
        getItemsQuestSearch(language: GetItemsQuestSearchLanguageEnum, game: GetItemsQuestSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): AxiosPromise<Array<ItemListEntry>> {
            return localVarFp.getItemsQuestSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class QuestItemsApi extends BaseAPI {
     ...
     */
    public getAllItemsQuestList(language: GetAllItemsQuestListLanguageEnum, game: GetAllItemsQuestListGameEnum, sortLevel?: GetAllItemsQuestListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, acceptEncoding?: GetAllItemsQuestListAcceptEncodingEnum, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig) {
        return QuestItemsApiFp(this.configuration).getAllItemsQuestList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding, filterTypeEnum, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof QuestItemsApi
     */
    public getItemsQuestList(language: GetItemsQuestListLanguageEnum, game: GetItemsQuestListGameEnum, sortLevel?: GetItemsQuestListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, pageSize?: number, pageNumber?: number, fieldsItem?: Set<GetItemsQuestListFieldsItemEnum>, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig) {
        return QuestItemsApiFp(this.configuration).getItemsQuestList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem, filterTypeEnum, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof QuestItemsApi
     */
    public getItemsQuestSearch(language: GetItemsQuestSearchLanguageEnum, game: GetItemsQuestSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig) {
        return QuestItemsApiFp(this.configuration).getItemsQuestSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const ResourcesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {GetAllItemsResourcesListGameEnum} game 
         ...
         * @throws {RequiredError}
         */
        getAllItemsResourcesList: async (language: GetAllItemsResourcesListLanguageEnum, game: GetAllItemsResourcesListGameEnum, sortLevel?: GetAllItemsResourcesListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, acceptEncoding?: GetAllItemsResourcesListAcceptEncodingEnum, filterTypeEnum?: Set<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'language' is not null or undefined
         ...
         * @param {GetItemsResourceSearchGameEnum} game 
         * @param {string} query case sensitive search query
         * @param {string} [filterTypeName] only results with the translated type name
         * @param {number} [filterMinLevel] only results which level is equal or above this value
         * @param {number} [filterMaxLevel] only results which level is equal or below this value
         ...
         * @throws {RequiredError}
         */
        getItemsResourceSearch: async (language: GetItemsResourceSearchLanguageEnum, game: GetItemsResourceSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'language' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getItemsResourcesList: async (language: GetItemsResourcesListLanguageEnum, game: GetItemsResourcesListGameEnum, sortLevel?: GetItemsResourcesListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, pageSize?: number, pageNumber?: number, fieldsItem?: Set<GetItemsResourcesListFieldsItemEnum>, filterTypeEnum?: Set<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'language' is not null or undefined
         ...
         * @param {number} ankamaId identifier
         * @param {GetItemsResourcesSingleGameEnum} game 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
...
export const ResourcesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllItemsResourcesList(language: GetAllItemsResourcesListLanguageEnum, game: GetAllItemsResourcesListGameEnum, sortLevel?: GetAllItemsResourcesListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, acceptEncoding?: GetAllItemsResourcesListAcceptEncodingEnum, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ItemsListPaged>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllItemsResourcesList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding, filterTypeEnum, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async getItemsResourceSearch(language: GetItemsResourceSearchLanguageEnum, game: GetItemsResourceSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ItemListEntry>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getItemsResourceSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async getItemsResourcesList(language: GetItemsResourcesListLanguageEnum, game: GetItemsResourcesListGameEnum, sortLevel?: GetItemsResourcesListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, pageSize?: number, pageNumber?: number, fieldsItem?: Set<GetItemsResourcesListFieldsItemEnum>, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ItemsListPaged>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getItemsResourcesList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem, filterTypeEnum, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const ResourcesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllItemsResourcesList(language: GetAllItemsResourcesListLanguageEnum, game: GetAllItemsResourcesListGameEnum, sortLevel?: GetAllItemsResourcesListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, acceptEncoding?: GetAllItemsResourcesListAcceptEncodingEnum, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): AxiosPromise<ItemsListPaged> {
            return localVarFp.getAllItemsResourcesList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding, filterTypeEnum, options).then((request) => request(axios, basePath));
        },
        /**
         * Search in all names and descriptions of resource items with a query.
         * @summary Search Resources
         ...
         * @throws {RequiredError}
         */
        getItemsResourceSearch(language: GetItemsResourceSearchLanguageEnum, game: GetItemsResourceSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): AxiosPromise<Array<ItemListEntry>> {
            return localVarFp.getItemsResourceSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve a list of resource items.
         * @summary List Resources
         ...
         * @throws {RequiredError}
         */
        getItemsResourcesList(language: GetItemsResourcesListLanguageEnum, game: GetItemsResourcesListGameEnum, sortLevel?: GetItemsResourcesListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, pageSize?: number, pageNumber?: number, fieldsItem?: Set<GetItemsResourcesListFieldsItemEnum>, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig): AxiosPromise<ItemsListPaged> {
            return localVarFp.getItemsResourcesList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem, filterTypeEnum, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve a specific resource item with id.
         * @summary Single Resources
...
export class ResourcesApi extends BaseAPI {
     ...
     */
    public getAllItemsResourcesList(language: GetAllItemsResourcesListLanguageEnum, game: GetAllItemsResourcesListGameEnum, sortLevel?: GetAllItemsResourcesListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, acceptEncoding?: GetAllItemsResourcesListAcceptEncodingEnum, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig) {
        return ResourcesApiFp(this.configuration).getAllItemsResourcesList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding, filterTypeEnum, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ResourcesApi
     */
    public getItemsResourceSearch(language: GetItemsResourceSearchLanguageEnum, game: GetItemsResourceSearchGameEnum, query: string, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, limit?: number, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig) {
        return ResourcesApiFp(this.configuration).getItemsResourceSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ResourcesApi
     */
    public getItemsResourcesList(language: GetItemsResourcesListLanguageEnum, game: GetItemsResourcesListGameEnum, sortLevel?: GetItemsResourcesListSortLevelEnum, filterTypeName?: string, filterMinLevel?: number, filterMaxLevel?: number, pageSize?: number, pageNumber?: number, fieldsItem?: Set<GetItemsResourcesListFieldsItemEnum>, filterTypeEnum?: Set<string>, options?: RawAxiosRequestConfig) {
        return ResourcesApiFp(this.configuration).getItemsResourcesList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem, filterTypeEnum, options).then((request) => request(this.axios, this.basePath));
    }
...
export const SetsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {GetAllSetsListGameEnum} game 
         ...
         * @param {GetSetsListGameEnum} game 
         ...
         * @param {GetSetsSearchGameEnum} game 
         * @param {string} query case sensitive search query
         * @param {number} [filterMinHighestEquipmentLevel] only results where the equipment with the highest level is above or equal to this value
         * @param {number} [filterMaxHighestEquipmentLevel] only results where the equipment with the highest level is below or equal to this value
         * @param {number} [limit] maximum number of returned results
         ...
         * @param {number} ankamaId identifier
         * @param {GetSetsSingleGameEnum} game 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
...
export const SetsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllSetsList(language: GetAllSetsListLanguageEnum, game: GetAllSetsListGameEnum, sortLevel?: GetAllSetsListSortLevelEnum, filterMinHighestEquipmentLevel?: number, filterMaxHighestEquipmentLevel?: number, acceptEncoding?: GetAllSetsListAcceptEncodingEnum, filterIsCosmetic?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SetsListPaged>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllSetsList(language, game, sortLevel, filterMinHighestEquipmentLevel, filterMaxHighestEquipmentLevel, acceptEncoding, filterIsCosmetic, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async getSetsList(language: GetSetsListLanguageEnum, game: GetSetsListGameEnum, sortLevel?: GetSetsListSortLevelEnum, filterMinHighestEquipmentLevel?: number, filterMaxHighestEquipmentLevel?: number, pageSize?: number, pageNumber?: number, fieldsSet?: Set<GetSetsListFieldsSetEnum>, filterIsCosmetic?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SetsListPaged>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getSetsList(language, game, sortLevel, filterMinHighestEquipmentLevel, filterMaxHighestEquipmentLevel, pageSize, pageNumber, fieldsSet, filterIsCosmetic, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const SetsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllSetsList(language: GetAllSetsListLanguageEnum, game: GetAllSetsListGameEnum, sortLevel?: GetAllSetsListSortLevelEnum, filterMinHighestEquipmentLevel?: number, filterMaxHighestEquipmentLevel?: number, acceptEncoding?: GetAllSetsListAcceptEncodingEnum, filterIsCosmetic?: boolean, options?: RawAxiosRequestConfig): AxiosPromise<SetsListPaged> {
            return localVarFp.getAllSetsList(language, game, sortLevel, filterMinHighestEquipmentLevel, filterMaxHighestEquipmentLevel, acceptEncoding, filterIsCosmetic, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve a list of sets.
         * @summary List Sets
         ...
         * @throws {RequiredError}
         */
        getSetsList(language: GetSetsListLanguageEnum, game: GetSetsListGameEnum, sortLevel?: GetSetsListSortLevelEnum, filterMinHighestEquipmentLevel?: number, filterMaxHighestEquipmentLevel?: number, pageSize?: number, pageNumber?: number, fieldsSet?: Set<GetSetsListFieldsSetEnum>, filterIsCosmetic?: boolean, options?: RawAxiosRequestConfig): AxiosPromise<SetsListPaged> {
            return localVarFp.getSetsList(language, game, sortLevel, filterMinHighestEquipmentLevel, filterMaxHighestEquipmentLevel, pageSize, pageNumber, fieldsSet, filterIsCosmetic, options).then((request) => request(axios, basePath));
        },
        /**
         * Search in all names and descriptions of sets with a query.
         * @summary Search Sets
         ...
         * @throws {RequiredError}
         */
        getSetsSearch(language: GetSetsSearchLanguageEnum, game: GetSetsSearchGameEnum, query: string, filterMinHighestEquipmentLevel?: number, filterMaxHighestEquipmentLevel?: number, limit?: number, filterIsCosmetic?: boolean, options?: RawAxiosRequestConfig): AxiosPromise<Array<SetListEntry>> {
...
export class SetsApi extends BaseAPI {
     ...
     * @memberof SetsApi
     */
    public getAllSetsList(language: GetAllSetsListLanguageEnum, game: GetAllSetsListGameEnum, sortLevel?: GetAllSetsListSortLevelEnum, filterMinHighestEquipmentLevel?: number, filterMaxHighestEquipmentLevel?: number, acceptEncoding?: GetAllSetsListAcceptEncodingEnum, filterIsCosmetic?: boolean, options?: RawAxiosRequestConfig) {
        return SetsApiFp(this.configuration).getAllSetsList(language, game, sortLevel, filterMinHighestEquipmentLevel, filterMaxHighestEquipmentLevel, acceptEncoding, filterIsCosmetic, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof SetsApi
     */
    public getSetsList(language: GetSetsListLanguageEnum, game: GetSetsListGameEnum, sortLevel?: GetSetsListSortLevelEnum, filterMinHighestEquipmentLevel?: number, filterMaxHighestEquipmentLevel?: number, pageSize?: number, pageNumber?: number, fieldsSet?: Set<GetSetsListFieldsSetEnum>, filterIsCosmetic?: boolean, options?: RawAxiosRequestConfig) {
        return SetsApiFp(this.configuration).getSetsList(language, game, sortLevel, filterMinHighestEquipmentLevel, filterMaxHighestEquipmentLevel, pageSize, pageNumber, fieldsSet, filterIsCosmetic, options).then((request) => request(this.axios, this.basePath));
    }
